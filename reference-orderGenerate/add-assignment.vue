        ...
        <div class="header">
            ...
            <div class="header-item">
                ...
                <div class="header-item-content">
                    ...
                    <div class="content-item" :class="{ active: form.task_sub_type === 0 }" @click="form.task_sub_type = 0">立即</div>
                    <div class="content-item" :class="{ active: form.task_sub_type === 1 }" @click="form.task_sub_type = 1">定时</div>
                    <div class="content-item" :class="{ active: form.task_sub_type === 2 }" @click="form.task_sub_type = 2">循环</div>
                </div>
            </div>
        </div>
        <div class="content">
